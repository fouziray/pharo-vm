...
extern char * codeEntryFor(char *l_address);
extern char * codeEntryNameFor(char *l_address);
...
extern sqInt isPCWithinMethodZone(void *l_address);
...
extern void linkStaticSendAtintooffsetreceiver(sqInt callSiteReturnAddress, CogMethod *sendingMethod, CogMethod *targetMethod, sqInt theEntryOffset, sqInt receiver);
...
extern void printCogMethodFor(void *l_address);
extern void printTrampolineTable(void);
extern void printWhereIs(void *l_address);
...
extern int sizeOfTrampoline(char *l_address);
...
extern CogMethod * methodFor(void *l_address);
