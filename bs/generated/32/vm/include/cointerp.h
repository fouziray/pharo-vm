...
extern void ceInterpretMethodFromPICreceiver(sqInt aMethodObj, sqInt rcvr);
extern void ceMNUFromPICMNUMethodreceiver(sqInt aMethodObj, sqInt rcvr);
...
extern void ceReturnToInterpreter(sqInt anOop);
...
extern void ceStaticSendInterpreted(sqInt aCompiledMethodOop);
extern void ceStaticSendtonumArgs(sqInt methodToGoTo, sqInt rcvr, sqInt numArgs);
...
extern sqInt withoutForwardingOnandwithsendToCogit(sqInt obj1, sqInt obj2, sqInt aBool, sqInt (*l_selector)(sqInt,sqInt,sqInt));
...
extern sqInt formatOfClassSafe(sqInt oop);
...
extern sqInt isInObjectMemory(sqInt anOop);
...
extern sqInt setMaxOldSpaceSize(usqInt l_limit);
...
extern void setDesiredStackPageBytes(sqInt desiredBytes);
